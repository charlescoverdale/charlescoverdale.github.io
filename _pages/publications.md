...
**Coverdale, C.** (2026). *climatekit: Unified Climate Indices for Temperature, Precipitation, and Drought in R.* Working paper, 2026. \[[PDF](/files/coverdale_climatekit_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/climatekit/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/climatekit)\]
...
**Coverdale, C.** (2026). *nowcast: Economic Nowcasting with Bridge Equations and Real-Time Evaluation in R.* Working paper, 2026. \[[PDF](/files/coverdale_nowcast_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/nowcast/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/nowcast)\]
...
**Coverdale, C.** (2026). *mpshock: An R Package for Cross-Country Monetary Policy Shock Analysis.* Working paper, 2026. \[[PDF](/files/coverdale_mpshock_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/mpshock/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/mpshock)\]
...
**Coverdale, C.** (2026). *inequality: Inequality Measurement, Decomposition, and Poverty Analysis in R.* Working paper, 2026. \[[PDF](/files/coverdale_inequality_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/inequality/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/inequality)\]
...
**Coverdale, C.** (2026). *debtkit: Debt Sustainability Analysis and Fiscal Risk Assessment in R.* Working paper, 2026. \[[PDF](/files/coverdale_debtkit_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/debtkit/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/debtkit)\]
...
**Coverdale, C.** (2026). *inflateR: Inflation Adjustment for Historical Currency Values Across Thirteen Currencies in R.* Working paper, 2026. \[[PDF](/files/coverdale_inflateR_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/inflateR/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/inflateR)\]
...
**Coverdale, C.** (2026). *yieldcurves: Yield Curve Fitting, Analysis, and Decomposition in R.* Working paper, 2026. \[[PDF](/files/coverdale_yieldcurves_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/yieldcurves/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/yieldcurves)\]
...
**Coverdale, C.** (2026). *predictset: Conformal Prediction and Uncertainty Quantification in R.* Working paper, 2026. \[[PDF](/files/coverdale_predictset_2026.pdf)\] \[[Rmd](https://github.com/charlescoverdale/predictset/blob/main/paper/rj/paper.Rmd)\] \[[code](https://github.com/charlescoverdale/predictset)\]
